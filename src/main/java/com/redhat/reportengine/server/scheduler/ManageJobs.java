...
public class ManageJobs {
	...
	public static void addAJobInScheduler(int id) throws SQLException{
		addJobInscheduler((JobScheduler)SqlMap.getSqlMapClient().queryForObject(SqlQuery.GET_JOB_SCHEDULER_BY_ID, id));
	}
	
	public static void addAJobInScheduler(String jobName) throws SQLException{
		addJobInscheduler((JobScheduler)SqlMap.getSqlMapClient().queryForObject(SqlQuery.GET_JOB_SCHEDULER_BY_NAME, jobName));
	}
	
	public static boolean removeAJobFromScheduler(int id) throws ParseException, SchedulerException, SQLException{
		return removeAJobFromScheduler(((JobScheduler)SqlMap.getSqlMapClient().queryForObject(SqlQuery.GET_JOB_SCHEDULER_BY_ID, id)).getJobName());
	}
	...
	public static void loadAllJobs() throws SQLException{
		ArrayList<JobScheduler> jobs = (ArrayList<JobScheduler>) SqlMap.getSqlMapClient().queryForList(SqlQuery.GET_JOB_SCHEDULER_ALL);
